package org.jeecg.learning.chapter6.tool.builder;
...
import org.jeecg.learning.chapter6.core.entity.BaseEntity;
import org.jeecg.learning.chapter6.core.entity.PersistableEntity;
import org.jeecg.learning.chapter6.core.web.json.DateJsonSerializer;
 ...
 * 生成的代码在：target/generated-codes目录下
...
public class SourceCodeFrameworkBuilder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 设置FreeMarker的模版文件位置
        cfg.setClassForTemplateLoading(SourceCodeFrameworkBuilder.class, "/org/jeecg/learning/chapter6/tool/builder/freemarker");
        ...
        Set<BeanDefinition> beanDefinitions = scanner.findCandidateComponents("org.jeecg.learning.chapter6");
        for (BeanDefinition beanDefinition : beanDefinitions) {
            debug(" - " + beanDefinition.getBeanClassName());
            entityNames.add(beanDefinition.getBeanClassName());
        }

        String generateRoot = "." + File.separator + "target" + File.separator + "generated-codes" + File.separator;
        new File(generateRoot).mkdirs();

        for (String entityName : entityNames) {

            String generateRootPath = generateRoot;
            ...
            root.put("table_name", "tbl_" + className.toUpperCase());
            ...
            generateRootPath = generateRootPath + rootPackagePath + modelPackagePath;
            process(cfg.getTemplate("JSP_Index.ftl"), root, generateRootPath + File.separator + "jsp" + File.separator, nameField + "-index.jsp");
            process(cfg.getTemplate("JSP_Input_Basic.ftl"), root, generateRootPath + File.separator + "jsp" + File.separator, nameField
                    + "-inputBasic.jsp");
